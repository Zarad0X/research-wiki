...
It is not meant to be a generic notes app. It is a research memory system maintained incrementally by agents and LLMs, with increasing emphasis on the repository owner's own questions, theses, taste, and research programs:

- markdown-first
- agent-first
- Obsidian-friendly
- built for questions, theses, programs, reviews, and evidence
...
└── wiki/
    ├── now.md            # current dashboard: what matters now
    ├── overview.md       # stable worldview / research map
    ├── index.md
    ├── log.md
...
10. Review [wiki/now.md](./wiki/now.md), [wiki/overview.md](./wiki/overview.md), and [wiki/index.md](./wiki/index.md).
...
- Within the vault, the human-facing starting points are [wiki/now.md](./wiki/now.md) and [wiki/overview.md](./wiki/overview.md).
